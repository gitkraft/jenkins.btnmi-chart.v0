...
<p align="center">
    <a href="https://gitkraft.com/router?gk_operation=fork&gk_name=jenkins.btnmi-chart.v0&gk_template_owner=tpl-gitkraft&gk_template_name=tpl.jenkins.btnmi-chart.v0&gk_description=Helm%20chart%20for%20jenkins%2C%20managed%20with%20GitKraft%20tooling&gk_visibility=private&mtm_campaign=fork&mtm_kwd=jenkins.btnmi-chart.v0">
...
This repository hosts the GitKraft's open-source **jenkins** Helm chart, originally
